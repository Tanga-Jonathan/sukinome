...
<body style="background-color: #b3821a;">
    ...
    <div class="col-lg-7">
      <center>
      <h3 style="padding-top: 8%; color: #fff;"><u> Contact Us </u> </h3>
       
    <img src="images/customer_care.jpg" alt="" style="width:30%" class="rounded-circle">
    ...
    <form action="" method="post" style="padding: 40px;">
      ...
      <input type="text" value="" name="name" placeholder="Enter your name" class="form-control" > <br>
      <input type="email"name="email" placeholder="Your Email" class="form-control" ><br>
      <textarea name="message"  cols="60" rows="2" class="form-control" placeholder="Message or Inquiry" ></textarea>
      <br> 
   ...
   <p style="color: #fff;">If you have inquiries or need assistance, do not hesitate to chat with us;
    We are available from Sunday to Friday between 9am to 6pm.</p>
  
    
    
    
    <a href="#"><img src="Images/whatsapp.png" alt="" width="8%" style="margin-right: 24px;"></a>
    <a href="#"><img src="Images/facebook.png" alt="" width="8%" style="margin-right: 24px;"></a>
    <a href="#"><img src="Images/twitter.png" alt="" width="8%"></a>
  <p style="color: #fff;">To place an order, call us on 163184135138 / 0548635415341 or WhatsApp us on 0700000000000000</p>
  </div>
